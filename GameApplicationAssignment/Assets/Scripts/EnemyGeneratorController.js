#pragma strict
//This script will generate enemyCharacters in a random position
//between x=8 to 10 AND y=-4 to 4 every second

//placeholder for the UFO
var enemyCharacter:Rigidbody;

function createEnemeyCharacter()
{
	var xposition:int;
	var yposition:int;
	...
	Instantiate(enemyCharacter,Vector3(xposition,yposition,0),Quaternion.identity);
}


function Start () {
	//wait for half a second, then repeat every second
	InvokeRepeating("createEnemyCharacter",2.5,2.0);
}
